package com.nt.niranjana.spboot2x.standaloneFileReader; //jar: poi-ooxml-5.2.2.jar    (Not working)
...
public class CreateTableIn_WordDocxFile {

	public static void main(String[] args) {
		createTableWord("C:\\Users\\Sreenivas Bandaru\\Downloads\\Sisu\\Sample files\\CreateWordDocxTable.docx");
	}
	...
	public static void createTableWord(final String fileName) {
		...
		try {
			...
			String t5 = "Sample Paragraph Post";
			r5.setText(t5);
			...
			String t6 = "Sample Paragraph Post";
			r6.setText(t6);
