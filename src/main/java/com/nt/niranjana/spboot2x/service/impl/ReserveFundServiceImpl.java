...
import com.nt.niranjana.spboot2x.dao.ReserveFundSearchDAO;
import com.nt.niranjana.spboot2x.model.ReserveFundSearchInputData;
import com.nt.niranjana.spboot2x.service.ReserveFundSearchService;

@Service
public class ReserveFundServiceImpl implements ReserveFundSearchService {
	private static Logger logger = LoggerFactory.getLogger(ReserveFundServiceImpl.class);
	static 
	{
		/*
		try 
